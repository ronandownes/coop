...
<div class="key-vocab"><span>diagnose</span><span>assumptions</span><span>method</span><span>validation</span></div>

<p class="recall"><strong>Recall cue:</strong> Problem → method → check → result.</p>
...
<div class="key-vocab"><span>ownership</span><span>correction</span><span>learning</span><span>process improvement</span></div>
...
<p class="recall"><strong>Recall cue:</strong> Break down → assumptions → test → ask intelligently.</p>
