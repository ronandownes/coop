...
intro: Use concise explanations. Show that you can calculate, interpret, challenge assumptions and communicate the result.
---
...
<div class="key-vocab"><span>probability-weighted</span><span>long-run average</span><span>uncertainty</span><span>dispersion</span></div>
...
<div class="key-vocab"><span>association</span><span>confounding</span><span>reverse causality</span><span>evidence</span></div>
...
<p class="recall"><strong>Recall cue:</strong> Assumptions → data → benchmark → sensitivity → decision.</p>
...
<div class="key-vocab"><span>present value</span><span>discounting</span><span>opportunity cost</span><span>cash flow</span></div>
...
<div class="key-vocab"><span>explanatory variable</span><span>prediction</span><span>diagnostics</span><span>assumptions</span></div>
...
<div class="key-vocab"><span>outlier</span><span>data quality</span><span>influence</span><span>robustness</span></div>
...
<div class="key-vocab"><span>objective function</span><span>constraints</span><span>feasible</span><span>allocation</span></div>
...
<p class="recall"><strong>Recall cue:</strong> Units → magnitude → benchmark → independent check.</p>
