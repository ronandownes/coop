...
intro: "A concise interview-ready page for CE4701 — Computer Software 1."
---
<p><a href="{{ '/modules-projects.html' | relative_url }}">← Modules & Projects</a></p>

## Module overview

This is the interview-level page for **CE4701 — Computer Software 1**. Add the lecturer's module overview or syllabus here, then reduce it to the main ideas Erik should be able to recognise and explain.
