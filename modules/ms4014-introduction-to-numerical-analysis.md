---
layout: doc
title: "MS4014 — Introduction to Numerical Analysis"
code: "MS4014"
year: "2nd"
semester: "Sem2"
status: "Core"
eyebrow: "2ND YEAR · SEM2"
intro: "A concise interview-ready page for MS4014 — Introduction to Numerical Analysis."
---
<p><a href="{{ '/modules-projects.html' | relative_url }}">← Modules & Projects</a></p>

## Module overview

This is the interview-level page for **MS4014 — Introduction to Numerical Analysis**. Add the lecturer's module overview or syllabus here, then reduce it to the main ideas Erik should be able to recognise and explain.
