---
layout: doc
title: "MS4613 — Vector Analysis"
code: "MS4613"
year: "2nd"
semester: "Sem1"
status: "Core"
eyebrow: "2ND YEAR · SEM1"
intro: "A concise interview-ready page for MS4613 — Vector Analysis."
---
<p><a href="{{ '/modules-projects.html' | relative_url }}">← Modules & Projects</a></p>

## Module overview

This is the interview-level page for **MS4613 — Vector Analysis**. Add the lecturer's module overview or syllabus here, then reduce it to the main ideas Erik should be able to recognise and explain.
